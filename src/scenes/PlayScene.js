...
class PlayScene extends BaseScene {
  ...
  create () {
    this.currentDifficulty = 'easy';
    super.create(); // executing create from super class - BaseScene.js
    this.createBird();
    this.createPipes();
  ...
  createPipes() {
    ...
    for (let i = 0; i < PIPES_TO_RENDER; i++) {
      let upper_pipe = this.pipes.create(0, 0, 'pipe')
        .setImmovable(true)
        .setOrigin(0,1);
        
      let lower_pipe = this.pipes.create(0, 0, 'pipe')
        .setImmovable(true)
        .setOrigin(0,0);

      // inside the loop call function to place pipes at random
